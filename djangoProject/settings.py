...
SECRET_KEY = 'django-insecure-i0p2-pt7q$eso97l(r3b7yz4e0+j2!)_n3x^qr-(jphp6n4_wl'
...
DATABASES = {
    ...
    #     'OPTIONS': {
    #         'sql_mode': 'traditional',  # 兼容 MySQL 5.7
    #     },
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app01/static'),  # 指向你的app下的static
]
...
SELLS_ADMIN_PASSWORD = 'txn751224'
######################### drf配置 ##########################
REST_FRAMEWORK={
